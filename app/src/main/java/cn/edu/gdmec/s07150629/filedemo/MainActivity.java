package cn.edu.gdmec.s07150629.filedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void phoneDirectory(View view) {
    ...
    public void externalStoragePublicDirectory(View view) {
        path = fExternalStorageDirectory.getAbsolutePath();
        listFiles(path);
    }

    public void externalStorageDirectory(View view) {
        path=fExternalStorageDirectory.getAbsolutePath();
        listFiles(path);
    }

    public void dataStorage(View view) {
    ...
    public void rootDirectory(View view) {
